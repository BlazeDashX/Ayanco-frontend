  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-slate-200 selection:bg-blue-500/30 font-sans">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden border-b border-white/5">
        ...
        {/* Animated Glow Orb */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-600/20 blur-[120px] rounded-full pointer-events-none animate-pulse" />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <motion.div style={{ y: yHero }} initial="hidden" animate="visible" variants={stagger}>
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8">
              ...
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-blue-200">Formerly Ayan International</span>
            </motion.div>
            
            <motion.h1 variants={fadeUp} className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-white mb-8 leading-[0.9]">
              The Standard <br />
            ...
            <motion.p variants={fadeUp} className="text-lg md:text-2xl font-light text-slate-400 max-w-3xl mx-auto leading-relaxed">
      ...
      {/* 2. STICKY SCROLL HISTORY: The Legacy */}
      <section ref={containerRef} className="py-32 bg-white text-slate-900 rounded-t-[60px] relative z-20 -mt-20 shadow-[0_-20px_60px_rgba(0,0,0,0.5)]">
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            <div className="lg:w-1/2 space-y-32 lg:pt-16">
              {/* Chapter 1: Origins */}
              <motion.div 
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h3 className="text-sm font-bold text-blue-600 uppercase tracking-widest">The Foundation</h3>
                </div>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                   ...
                   <h3 className="text-sm font-bold text-blue-600 uppercase tracking-widest">Mission & Vision</h3>
                </div>
      ...
      <section className="py-32 bg-[#0a0c10] text-white relative">
        <div className="container mx-auto px-6">
          <div className="mb-20 max-w-2xl">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tighter mb-6">Our DNA.</h2>
            <p className="text-slate-400 text-xl font-light">The core values that guide every contract, shipment, and handshake.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 auto-rows-[280px]">
            ...
            <motion.div 
              ...
              className="md:col-span-2 bg-gradient-to-br from-blue-900/40 to-slate-900/40 border border-white/10 rounded-3xl p-10 flex flex-col justify-between relative overflow-hidden group"
            >
              ...
              <div>
                <h3 className="text-3xl font-bold mb-3">Integrity First</h3>
                <p className="text-slate-400 leading-relaxed max-w-md">We do what we say. In an industry often plagued by opacity, we stand as a beacon of honest dealing. No hidden fees, no last-minute changes.</p>
              </div>
            </motion.div>
            ...
            <motion.div 
              whileHover={{ scale: 1.02 }}
              className="bg-slate-900/40 border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:bg-white/5 transition-colors"
            >
            ...
            <motion.div 
              whileHover={{ scale: 1.02 }}
              className="md:col-span-2 bg-gradient-to-br from-cyan-900/20 to-slate-900/40 border border-white/10 rounded-3xl p-10 flex flex-col justify-between relative overflow-hidden group"
            >
              <div className="absolute top-0 right-0 p-10 opacity-10 group-hover:opacity-20 transition-opacity">
                <Trophy size={120} />
              </div>
              ...
              <div>
                <h3 className="text-3xl font-bold mb-3">Unmatched Excellence</h3>
                <p className="text-slate-400 leading-relaxed max-w-md">From raw material selection to final delivery, our SQA (Software Quality Assurance) inspired processes ensure perfection.</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      {/* 4. FOUNDER'S MESSAGE: The Personal Touch */}
      <section className="py-32 bg-white text-slate-900">
        <div className="container mx-auto px-6">
          <div className="relative max-w-4xl mx-auto">
            <Quote className="absolute -top-10 -left-10 text-blue-100 w-32 h-32 -z-10" />
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center mt-12">
                 <div className="w-20 h-20 bg-slate-200 rounded-full mb-4 overflow-hidden">
                   {/* <Image src="/founder.jpg" width={80} height={80} alt="Founder" /> */}
                 ...
                 {/* Replace signature.png with a real image or remove if not available */}
              </div>
            </motion.div>
          </div>
        </div>
