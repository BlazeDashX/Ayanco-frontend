...
export default function FounderContact() {
  ...
  return (
    <section
      id="contact"
      className="min-h-dvh py-20 md:py-28 flex flex-col justify-center bg-[#111827] text-white relative overflow-hidden"
    >
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-lg mx-auto bg-gray-800/70 border border-gray-700 rounded-2xl p-7 sm:p-9 space-y-5 reveal" data-reveal="up">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href={`mailto:${email}`}
              className="text-gray-200 text-sm hover:text-(--gold) transition-colors"
            >
              {email}
            </Link>
          </div>
